...
export default function Header() {
  ...
  return (
    <header className={`sticky top-0 z-50 py-5 w-full transition-all duration-300 ${
      scrolled 
      ...
      <div className="section-container">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            ...
            <button className="btn-primary text-base py-2 lg:py-2.5 px-4 lg:px-5 group/btn w-full sm:w-auto">
